...
person.prototype.printInfo = function (arg) {
    console.log(this)
    return arg + ' ' + this.firstName + ' ' + this.lastName;
}
console.log(person.prototype.printInfo('Hi...'));
...
function trainee(firstName, lastName, subjectToLearn) {
    ...
    this.printInfo = function () {
        //var partialInfo = person.prototype.printInfo.apply(this, "Information of: ");
        var partialInfo = this.__proto__.printInfo.apply(this, ['Information of: ']);
